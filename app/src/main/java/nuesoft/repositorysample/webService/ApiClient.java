...
//
//            Authenticator.init(context, "KEY");
//
...
//
//                                    if (Authenticator.hasJwtToken()) {
//                                        String token = Authenticator.getJwtToken();
...
//                                            if (Authenticator.hasJwtToken() && identity.length() == 0) {
//                                                break;
//                                            }
//                                        }
//                                    }
...
//
//                                    if (newJwtToken != null) {
//                                        Authenticator.setJwtToken(newJwtToken);
//                                    }
//
//                                    return response;
//
